...
def get_mp_merge_args(parser):
    ...
    group.add_argument('--mp-model-parallel-size', type=int, required=True,
                       help='number of mp model to be merged.')
...
def main():
    ...
    orig_model_parallel_size = args.mp_model_parallel_size
